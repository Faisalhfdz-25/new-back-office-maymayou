...
@section('title', 'History Purchase')
@section('content')
    <div class="main">
        ...
        <div class="row">
            <div class="col">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/gudang-purchase"></a>Gudang Purchase</li>
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <div class="caption uppercase">
                            <i class="ti-file"></i> History Purchase
                        </div>
                        {{-- <div class="tools">
                            <a href="javascript:;" class="btn btn-sm btn-success exampleModalSize" data-size="lg"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card mb-3">
                        <form method="post" action="{{ url('inventory-list/simpan') }}" novalidate
