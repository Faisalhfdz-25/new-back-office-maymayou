    ...
    <div class="row">
        <div class="col">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Gudang Purchase</li>
            </ol>
        </div>
    </div>
    <!-- EOF Breadcrumb -->
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <div class="caption uppercase">
                        <i class="ti-file"></i> Gudang Purchase
                    </div>
                    <div class="tools">
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/gudang-purchase/history/{{ $item->kode }}" class="btn btn-sm btn-primary">History</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
