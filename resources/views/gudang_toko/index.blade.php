    ...
    <div class="row">
        <div class="col">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Gudang Toko</li>
            </ol>
        </div>
    </div>
    <!-- EOF Breadcrumb -->
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/gudang-toko/history/{{ $item->kode }}" class="btn btn-sm btn-primary">History</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
